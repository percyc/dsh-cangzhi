	...
	factory: (require) => {
		...
		*/
		function useKnowledgeSession() {
			const [sessionKey, setSessionKey] = (0, react.useState)(() => loadSessionKey());
			const [policy, setPolicyState] = (0, react.useState)(() => loadPolicy(sessionKey));
			(0, react.useEffect)(() => {
				const refresh = (event) => {
					const detail = event.detail;
					if (detail?.sessionKey !== void 0 && detail.sessionKey !== sessionKey) {
		...
		function KnowledgePopover(props) {
			...
			const policyOptions = [
				...
				{
					value: "auto",
					label: t("popoverPolicyAuto"),
					hint: t("popoverPolicyAutoHint")
				},
				{
					value: "always",
					label: t("popoverPolicyAlways"),
					hint: t("popoverPolicyAlwaysHint")
				}
			];
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								"data-global": String(true),
								children: t("popoverScopeBadgeGlobal")
							}),
		...
		function HomeIntegration({ openConsole, openKnowledge, t }) {
		...
		function KnowledgeDock({ openKnowledge, openConsole, inputActions, t }) {
			const [auth, setAuth] = (0, react.useState)(null);
			const [plugin, setPlugin] = (0, react.useState)(null);
			const [workspace, setWorkspace] = (0, react.useState)(null);
			const [workspaces, setWorkspaces] = (0, react.useState)([]);
		...
		function ConversationKnowledgeHeader({ openKnowledge, t }) {
