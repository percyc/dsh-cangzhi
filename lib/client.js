window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function AssistantEvidenceAction({ messageId, useChat }) {
			const evidence = answerEvidence(useChat((snapshot) => {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				type: "button",
				className: Cangzhi_module_css_default.assistantEvidenceAction,
				"aria-label": label,
				title: label,
				onClick: () => openDocumentInWorkbench(evidence.documentId, evidence.title, evidence.datasetId ?? void 0),
				children: "▤ 来源"
			});
		}
