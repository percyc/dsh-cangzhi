	...
	factory: (require) => {
		...
		*/
		function truncateEvidenceMarkdown(text, options = {}) {
			...
			if (newline > bodyBudget * .5) end = newline;
			let body = text.slice(0, end).trimEnd();
			while (body.length > 0 && byteLengthUtf8(`${body}${markerBlock}`) > limit) body = body.slice(0, body.length - 1).trimEnd();
		...
		*/
		...
		function EvidenceWorkbenchPreview({ context, rows }) {
			...
			const truncatedMarkdown = (0, react.useMemo)(() => effectiveView === "formatted" ? truncateEvidenceMarkdown(normalizedMarkdown) : normalizedMarkdown, [normalizedMarkdown, effectiveView]);
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					showFormatBar && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: Cangzhi_module_css_default.markdownFormatBar,
						role: "tablist",
						"aria-label": "证据 Markdown 渲染模式",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							role: "tab",
					...
					normalizedMarkdown && effectiveView === "formatted" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: Cangzhi_module_css_default.cangzhiMarkdown,
						"data-cangzhi-markdown": "evidence",
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.MarkdownText, {
							text: truncatedMarkdown,
							labels: markdownLabels
						})
					}),
					normalizedMarkdown && effectiveView === "raw" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("pre", {
						className: Cangzhi_module_css_default.markdownPreview,
						children: normalizedMarkdown
					}),
					!normalizedMarkdown && context.snippet && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("blockquote", { children: context.snippet }),
					rows && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					!normalizedMarkdown && !context.snippet && !rows && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		function KnowledgeWorkbench({ useCangzhiConsole, openKnowledge, closeKnowledge, openConsole }) {
			...
			const loadDatasetRows = async (datasetId, offset, limit) => {
			...
			const preview = async (item) => {
				...
				if (item.content_kind === "dataset" || item.dataset_id !== void 0 || /\.(xlsx?|xls)$/iu.test(item.title)) {
			...
			const changeTablePage = (offset, limit = previewTable?.limit ?? PREVIEW_PAGE_SIZE) => {
				...
				loadDatasetRows(previewTable.datasetId, offset, limit);
			};
			const previewEvidence = async (evidence) => {
				...
				setEvidenceContext(await response.json());
