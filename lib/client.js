window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var Cangzhi_module_css_default = {
			...
			"workbenchSizeGroup": "sRLa1a_workbenchSizeGroup",
		...
		const WORKBENCH_FULLSCREEN_MAX = 1100;
		...
		const WORKBENCH_SIZE_LABELS_ZH = Object.freeze({
			narrow: "窄",
			standard: "标准",
			wide: "宽"
		});
		const WORKBENCH_SIZE_GLYPHS = Object.freeze({
			narrow: "▮",
			standard: "▮▮",
			wide: "▮▮▮"
		});
		const SIZE_KEYS = new Set(WORKBENCH_SIZES);
		function isWorkbenchSize(value) {
		...
		function detectWorkbenchSize(width) {
		...
		function readWorkbenchFullscreenFromStorage(storage) {
			return makeStorageLike(storage.getItem.bind(storage)).getItem("cangzhi-workbench-fullscreen") === "true";
		}
		function readRawWorkbenchSize(storage) {
			const raw = makeStorageLike(storage.getItem.bind(storage)).getItem("cangzhi-workbench-size");
			return typeof raw === "string" ? raw : null;
		}
		function readWorkbenchInitialState(storage) {
			const rawSize = readRawWorkbenchSize(storage);
			if (isWorkbenchSize(rawSize)) return {
				size: rawSize,
		...
		function sizeLabel(option) {
			return WORKBENCH_SIZE_LABELS_ZH[option] ?? "";
		}
		function sizeGlyph(option) {
		...
		*/
		...
		function evidenceLinkFromObject(value) {
			...
			return {
				documentId,
				datasetId: idNumber(object.dataset_id ?? object.datasetId),
				title: typeof object.title === "string" && object.title.trim().length > 0 ? object.title.trim() : typeof object.document_title === "string" && object.document_title.trim().length > 0 ? object.document_title.trim() : `资料 #${String(documentId)}`,
				snippet: typeof object.snippet === "string" ? object.snippet : typeof object.summary === "string" ? object.summary : void 0
			};
		}
		...
		*/
		...
		function KnowledgeWorkbench({ useCangzhiConsole, openKnowledge, closeKnowledge, openConsole }) {
			...
			const [busy, setBusy] = (0, react.useState)(false);
			const [notice, setNotice] = (0, react.useState)("");
			const [width, setWidth] = (0, react.useState)(() => readWorkbenchInitialState(window.localStorage).width);
			const [size, setSize] = (0, react.useState)(() => readWorkbenchInitialState(window.localStorage).size);
			const [fullscreen, setFullscreen] = (0, react.useState)(() => readWorkbenchInitialState(window.localStorage).fullscreen);
			...
			const toggleFullscreen = () => {
				setFullscreen((previous) => {
					const next = !previous;
					try {
						window.localStorage.setItem("cangzhi-workbench-fullscreen", String(next));
					} catch {}
					return next;
				});
			};
			...
			const renderWidth = fullscreen ? `min(100vw - 32px, ${WORKBENCH_FULLSCREEN_MAX}px)` : width;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("aside", {
				className: Cangzhi_module_css_default.knowledgeWorkbench,
				"data-cangzhi-workbench-fullscreen": String(fullscreen),
				"data-cangzhi-workbench-size": size,
				"aria-label": "藏知工作台",
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						"data-disabled": String(fullscreen)
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
						className: Cangzhi_module_css_default.workbenchHeader,
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(CangzhiMark, { size: 25 }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: "藏知工作台" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("small", { children: workspace?.name ?? "当前知识空间" })] })] }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: Cangzhi_module_css_default.workbenchSizeGroup,
								role: "group",
								"aria-label": "工作台宽度档位",
								children: [WORKBENCH_SIZES.map((option) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									"data-active": String(size === option),
									"aria-pressed": size === option,
									"aria-label": sizeLabel(option),
									title: sizeLabel(option),
									onClick: () => selectSize(option),
									children: sizeGlyph(option)
								}, option)), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									"data-active": String(fullscreen),
									"aria-pressed": fullscreen,
									"aria-label": fullscreen ? "退出全屏阅读" : "进入全屏阅读",
									title: fullscreen ? "退出全屏阅读" : "进入全屏阅读",
