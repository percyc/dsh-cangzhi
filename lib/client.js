window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var Cangzhi_module_css_default = {
			...
			"bookIcon": "sRLa1a_bookIcon",
			"brand": "sRLa1a_brand",
			"cangzhiBrandName": "sRLa1a_cangzhiBrandName",
